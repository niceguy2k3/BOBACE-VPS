...
const EmailVerificationAlert = ({ email }) => {
      ...
      <div className="flex">
        ...
        <div className="ml-3">
          <p className="text-sm text-yellow-700">
            Tài khoản của bạn chưa được xác thực. Vui lòng kiểm tra email và nhấp vào liên kết xác thực.
          </p>
          <div className="mt-2">
            <button
            ...
            >
              {resending ? (
                <div className="flex items-center">
                  <Loader size="small" color="yellow" />
